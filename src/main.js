...
const rimLight = new THREE.DirectionalLight(0xbf40bf, 1.5);
rimLight.position.set(-20, 10, -20);
scene.add(rimLight);

const fillLight1 = new THREE.PointLight(0x22d3ee, 0.8, 100);
fillLight1.position.set(-10, 10, 10);
scene.add(fillLight1);

const fillLight2 = new THREE.PointLight(0xa78bfa, 0.6, 100);
